...
NGame = {
	...
	AGE_USHER_IN_TIME = 12,				-- how many months progress for a new age needs. test for github bot
...
NMilitary = {
	...
	MERCENARY_SUPPORT_LIMIT_BASE = 15,				-- Base (and thus minimum) value for mercenary support limit.
